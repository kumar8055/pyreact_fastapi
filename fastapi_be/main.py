...
## Custom imports
from stocks import getStocksInfo,getHistoryData,getTickerDates #type:ignore
...
@app.post("/stocks/{ticker}/dates")
def stocksHistory(ticker:str):
    ticker_dates = getTickerDates(ticker)
    return {ticker: ticker_dates}
